...
print("                                   -------------------->>>>>>>>>>>>> Thar Share Brokers Private Limited <<<<<<<<<<<<<---------------------")


# changing voice to male or female voice depending on the user's input
pyttsx3.speak("Greetings, this is strydo, a personal voice assistant made by Khushal Jain, which will be there for you everytime you need it. Tell me, you wanna talk to Ben or Kate?")
